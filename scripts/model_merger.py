...
if __name__ == "__main__":
    ...
    parser.add_argument("--local_dir", "-d", required=True, type=str, help="The path for your saved model")
    parser.add_argument("--hf_upload_path", "-u", default=False, type=str, help="The path of the huggingface repo to upload")
